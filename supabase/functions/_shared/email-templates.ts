...
function hubfyFooter(): string {
  return `        <p style="font-size: 16px; font-weight: 700; color: ${COLOR_TEXT}; margin: 0;">
          <a href="https://hubfy.io" style="text-decoration: none; color: ${COLOR_TEXT};">Hubfy</a>
        </p>`;
}
...
function tenantFooter(
  ...
  return `        <p style="font-size: 16px; font-weight: 700; color: ${COLOR_TEXT}; margin: 0;">
          ${tenantName} <span style="font-weight: 400; color: ${COLOR_MUTED}; font-size: 14px;">${viaLabel}</span> <a href="https://hubfy.io" style="text-decoration: none; color: ${COLOR_TEXT};">Hubfy</a>
        </p>`;
}

function poweredByFooter(label: string): string {
  return `        <p style="font-size: 13px; font-weight: 400; color: #b0b0b0; margin: 0;">
          ${label} <a href="https://hubfy.io" style="text-decoration: none; color: #b0b0b0; font-weight: 700;">Hubfy</a>
        </p>`;
}
