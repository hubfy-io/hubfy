    ...
    <tr>
      <td>
        ...
        <p style="font-size: 16px; font-weight: 700; color: #1a1a1a; margin: 0;">
          ${tenantName} <span style="font-weight: 400; color: #999999; font-size: 14px;">via</span> <a href="https://hubfy.io" style="text-decoration: none; color: #1a1a1a;">Hubfy</a>
        </p>
      </td>
    </tr>
  </table>
...
async function sendEmail(params: {
  ...
  const res = await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      from: `${params.senderName} <noreply@notifications.hubfy.io>`,
      to: [params.to],
