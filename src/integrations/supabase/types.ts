  ...
  public: {
    Tables: {
      ...
      customer_onboarding_responses: {
        ...
        Relationships: [
          {
            foreignKeyName: "customer_onboarding_responses_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "customer_onboarding_responses_onboarding_id_fkey"
            columns: ["onboarding_id"]
            isOneToOne: false
            referencedRelation: "customer_onboardings"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "customer_onboarding_responses_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      customer_onboardings: {
        ...
        Relationships: [
          {
            foreignKeyName: "customer_onboardings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      onboarding_products: {
        ...
        Relationships: [
          {
            foreignKeyName: "onboarding_products_onboarding_id_fkey"
            columns: ["onboarding_id"]
            isOneToOne: false
            referencedRelation: "customer_onboardings"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "onboarding_products_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "onboarding_products_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_required_customer_onboarding: {
      ...
      submit_customer_onboarding_response: {
        Args: { p_answers: Json; p_onboarding_id: string }
        Returns: string
      }
