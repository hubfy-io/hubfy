...
type LoginProps = {
  /** Ex: "/creator" para usar rotas /creator/login, /creator/signup... */
  basePath?: string;
};

export default function Login({ basePath = "" }: LoginProps) {
  ...
  // After login, ProtectedRoute will redirect to /admin/new-workspace when needed
  const rawFrom =
  ...
  return (
    <AuthLayout heroImage={heroImage}>
        ...
        <div className="rounded-lg border border-primary/20 bg-primary/5 p-4 space-y-3">
          ...
          >
            {isResending ? (
              ...
              t("auth.emailConfirmation.resendConfirmation")
            )}
          </Button>
        </div>
      )}
      ...
      <div className="text-center text-sm text-muted-foreground">
        ...
        <Link to={signupPath} className="text-primary hover:underline">
