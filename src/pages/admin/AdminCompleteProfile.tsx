  ...
  return (
    <section className="py-20">
      <div className="fixed top-0 left-0 right-0 z-10 flex items-center justify-between p-6">
        <a href="https://hubfy.io" target="_blank" rel="noopener noreferrer">
          <img src="/brand/logo-hubfy-dark.svg" alt="Hubfy" className="h-6 dark:hidden" />
          <img src="/brand/logo-hubfy-light.svg" alt="Hubfy" className="h-6 hidden dark:block" />
        </a>
