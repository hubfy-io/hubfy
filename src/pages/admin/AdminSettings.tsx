...
import { Loader2, ExternalLink, Check, Users, Box, Trash2, Plus, X, CircleDollarSign, Upload, Send, Copy, KeySquare } from "lucide-react";
...
export default function AdminSettings() {
  ...
  const menuItems: { id: string; label: string; icon: React.ElementType }[] = [
    ...
    { id: "emails", label: t("settings.tabs.emails"), icon: Send },
    ...(isWorkspaceOwner ? [{ id: "api-keys", label: "API Keys", icon: KeySquare }] : []),
                      ...
                      <div className="flex">
                        ...
                        <div className="relative flex-1">
                          ...
                          <div className="absolute right-3 top-1/2 flex -translate-y-1/2 items-center gap-2">
                            ...
                            <a
                              href={`https://hubfy.io/${formData.slug}`}
                              target="_blank"
              ...
              <Card variant="bordered" className="mt-6">
                ...
                <CardContent className="space-y-6">
                  ...
                  <Field orientation={isMobile ? "vertical" : "split"}>
                    ...
                    <FieldControl>
                      <Input
                        value="noreply@notifications.hubfy.io"
                        disabled
