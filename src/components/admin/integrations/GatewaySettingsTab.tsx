      ...
      {optionalFields.length > 0 && (
        <Card variant="bordered">
          ...
          <CardContent className="space-y-6">
            ...
            {provider === "greenn" && (
              <div className="rounded-md bg-muted/50 border p-4 space-y-1">
                <p className="text-sm text-muted-foreground">
                  Gere e copie as chaves em{" "}
                  <a
                    href="https://adm.greenn.com.br/configuracoes?action=Tokens-and-API"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary underline underline-offset-2"
                  >
                    Configurações → Integrações e Tokens → Chaves de acesso
                  </a>{" "}
                  no painel da Greenn.
                </p>
              </div>
