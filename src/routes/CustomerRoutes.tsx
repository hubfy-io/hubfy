...
const CustomerOnboardingPage = lazy(() => import("@/pages/portal/CustomerOnboardingPage"));
...
/**
 * All non-admin, non-checkout routes: landing, showcases, tenant public pages,
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        {/* ═══ Customer Onboarding obrigatório ═══ */}
        <Route
          path="/:slug/onboarding"
          element={
            <CustomerPortalRoute allowOnboarding>
