...
const AdminCheckouts = lazy(() => import("@/pages/admin/AdminCheckouts"));
...
const AdminEmailBroadcasts = lazy(() => import("@/pages/admin/AdminEmailBroadcasts"));
const AdminEmailContacts = lazy(() => import("@/pages/admin/AdminEmailContacts"));
const AdminBroadcastDetail = lazy(() => import("@/pages/admin/AdminBroadcastDetail"));
const AdminOnboardings = lazy(() => import("@/pages/admin/AdminOnboardings"));

// Full-screen pages (no sidebar)
const AdminCheckoutEdit = lazy(() => import("@/pages/admin/AdminCheckoutEdit"));
const AdminBroadcastEdit = lazy(() => import("@/pages/admin/AdminBroadcastEdit"));
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
          ...
          />
          <Route
            path="/email/broadcasts/:broadcastId/edit"
            element={
              <ProtectedRoute>
                <AdminBroadcastEdit />
              </ProtectedRoute>
          ...
          >
            ...
            <Route path="/email/broadcasts/:broadcastId" element={<AdminBroadcastDetail />} />
            <Route path="/email/contacts" element={<AdminEmailContacts />} />
