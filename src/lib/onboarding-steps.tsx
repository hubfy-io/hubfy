...
export const USED_TOOLS = [
  ...
  "Zoom", "Vimeo", "Asaas", "ActiveCampaign", "Hubspot", "Guru",
        ...
        <form onSubmit={(e) => e.preventDefault()} className="space-y-6 py-4">
          ...
          <div className="space-y-6 pt-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex">
                <span className="inline-flex items-center px-3 rounded-l-xl bg-muted text-muted-foreground text-sm border border-r-0 border-border whitespace-nowrap">hubfy.io/</span>
