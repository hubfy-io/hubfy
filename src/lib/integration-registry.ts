 ...
 *   - ActiveCampaignDialog.tsx (hardcoded logo, name, helpUrl)
...
export const PROVIDERS: Record<ProviderKey, ProviderDefinition> = {
  ...
  adyen: {
    ...
    displayName: "Adyen",
    category: "payments",
    descriptionKey: "integrations.providers.adyen.description",
    logo: "/brand/integrations/adyen.webp",
    available: false,
  },
  hotmart: {
    key: "hotmart",
  ...
  kiwify: {
    ...
    displayName: "Kiwify",
    category: "payments",
    descriptionKey: "integrations.providers.kiwify.description",
    logo: "/brand/integrations/kiwify.svg",
    available: true,
  },
  kirvano: {
    key: "kirvano",
    displayName: "Kirvano",
    category: "payments",
    descriptionKey: "integrations.providers.kirvano.description",
    logo: "/brand/integrations/kirvano.svg",
    available: true,
  },
  lastlink: {
    key: "lastlink",
    ...
    category: "payments",
    descriptionKey: "integrations.providers.lastlink.description",
    logo: "/brand/integrations/lastlink.svg",
    available: true,
  },
  greenn: {
    key: "greenn",
    displayName: "Greenn",
    category: "payments",
    descriptionKey: "integrations.providers.greenn.description",
    logo: "/brand/integrations/greenn.svg",
    available: true,
  },
  paypal: {
    key: "paypal",
    displayName: "PayPal",
    category: "payments",
    descriptionKey: "integrations.providers.paypal.description",
    logo: "/brand/integrations/paypal.webp",
    available: false,
  },
  stripe: {
    key: "stripe",
    displayName: "Stripe",
    category: "payments",
    descriptionKey: "integrations.providers.stripe.description",
    logo: "/brand/integrations/stripe.png",
    available: false,
  },
  ...
  activecampaign: {
    ...
    category: "crm",
    descriptionKey: "integrations.providers.activecampaign.description",
    logo: "/brand/integrations/activecampaign.svg",
    available: true,
    helpUrl:
      "https://help.activecampaign.com/hc/en-us/articles/207317590",
    placeholders: {
      api_url: "https://suaconta.api-us1.com",
      api_key: "••••••••••••••••",
    },
  },
  chatbase: {
