...
export type GatewayProvider = "hotmart" | "kiwify" | "kirvano" | "lastlink" | "greenn";
  ...
  kiwify: [
    {
      ...
      required: true,
      type: "text",
      helpText: "Encontre no painel da Kiwify > Configurações > Webhooks",
      placeholder: "Cole o token de segurança aqui",
    },
    {
      key: "api_key",
      label: "Client ID",
      required: false,
      type: "text",
      helpText: "Gerado no painel da Kiwify.",
    ...
    },
    {
      ...
      required: false,
      type: "password",
      helpText: "Gerado junto com o Client ID. Guarde em local seguro.",
    ...
    },
    {
      ...
      required: false,
      type: "text",
      helpText: "Encontre no painel da Kiwify, no mesmo local que gerou o Client ID.",
      placeholder: "ex: XvS0qfkdzCZTg8z",
    },
  ],
  kirvano: [
    {
      ...
      required: true,
      type: "text",
      helpText: "Encontre no painel da Kirvano > Integrações > Webhooks",
  ...
  lastlink: [
    {
      ...
      required: true,
      type: "text",
      helpText: "Encontre no painel da Lastlink > Configurações > Webhooks",
      placeholder: "Cole o token do webhook aqui",
    },
  ],
  greenn: [
    {
      ...
      required: true,
      type: "text",
      helpText: "Encontre em Configurações → Integrações e Tokens → Webhook no painel da Greenn.",
      placeholder: "Cole o Webhook Token aqui",
    },
    {
      key: "public_key",
      label: "Public Key",
      required: false,
      type: "text",
      helpText: "Encontre em Configurações → Integrações e Tokens → Chaves de acesso no painel da Greenn.",
    ...
    },
    {
      ...
      required: false,
      type: "password",
      helpText: "Gerada junto com a Public Key. Guarde em local seguro.",
...
export function providerSupportsSyncApi(provider: GatewayProvider): boolean {
  return provider === "hotmart" || provider === "kiwify";
}
...
export function getApiCredentialKeys(provider: GatewayProvider): string[] {
  ...
  if (provider === "kiwify") return ["account_id", "api_key", "client_secret"];
  return [];
}
